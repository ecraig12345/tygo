...
Basic enum generation with enum_style: "literal_union"

```yaml
enum_style: "literal_union"
```
...
Numeric literal union with iota
...
Mixed const block (partial literal union)
